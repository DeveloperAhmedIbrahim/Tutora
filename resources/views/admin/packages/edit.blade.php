                    ...
                    <form action="{{ url('admin/packages/update') }}" method="post">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" cols="30" rows="3" class="form-control">{{ old('description',$package->description) }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="details" id="ckeditor" cols="30" rows="10" class="form-control">{{ old('details', $package->details) }}</textarea>
                                @error('details')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
