...
<head>
    ...
    <title>Contact-Us-Template</title><!--[if (mso 16)]>
    <style type="text/css">
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#1B4965;font-size:16px"><img
                                                                            src="{{ asset('assets/images/email.png') }}"
                                                                            alt="Your Feedback Matters!" width="170"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <h3
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:22px;font-style:normal;font-weight:bold;line-height:26px;color:#333333">
                                                                        {{ $data["name"] }},</h3>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:24px;letter-spacing:0;color:#333333;font-size:16px">
                                                                        <br></p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:24px;letter-spacing:0;color:#333333;font-size:16px">
                                                                        <strong>Sender Email</strong>: {{ $data['email'] }} <br><br></p>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <table border="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="padding:0;Margin:0;border-bottom:1px solid #bee9e8;background:unset;height:1px;width:100%;margin:0px">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        thetutora.com</p>
                                                                </td>
                                                            </tr>
                                                        </table>
