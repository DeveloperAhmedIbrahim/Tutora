...
use App\Http\Controllers\Admin\CourseController AS _CourseController;
...
Route::prefix('admin')->middleware(AdminGuard::class)->group(function(){
    ...
    Route::prefix('courses')->group(function(){
        Route::get('list',[_CourseController::class,'list']);
        Route::get('new',[_CourseController::class,'new']);
        Route::get('edit/{id}',[_CourseController::class,'edit']);
        Route::get('delete/{id}',[_CourseController::class,'delete']);
        Route::post('insert',[_CourseController::class,'insert']);
        Route::post('update',[_CourseController::class,'update']);
    });
});
